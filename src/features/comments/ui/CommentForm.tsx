  ...
  return (
    <form onSubmit={handleSubmit} className="mb-8 space-y-4">
      ...
      <textarea
        ...
        className="min-h-25 w-full resize-y rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
      />
      <button
        type="submit"
